                            ...
                            <thead>
                                ...
                                <tbody>
                                    <c:forEach var="file" items="${files}">
                                        <tr>
                                            <td>${file.name}</td>
                                            <td class="text-center"><a href="getSaleReport?fileName=${file.name}"><span style="font-size:25px;" class="glyphicon glyphicon-download"></span></a></td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
                            </thead>

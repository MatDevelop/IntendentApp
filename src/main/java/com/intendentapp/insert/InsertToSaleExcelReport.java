...
public class InsertToSaleExcelReport {
    ...
    public InsertToSaleExcelReport(ConsumerEntity consumer, SaleReport saleReport, String filename, String outfilename){
        ...
        setStyles();
        names=new LinkedList<String>(Arrays.asList(consumer.getName().split(",")));
        surnames=new LinkedList<String>(Arrays.asList(consumer.getSurname().split(",")));
        addresses=new LinkedList<String>(Arrays.asList(consumer.getAddress().split(",")));
        unpaid=0;
